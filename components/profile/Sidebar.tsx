      ...
      <div className=" py-4 px-3 w-full h-full bg-gray-50  dark:bg-gray-800">
        ...
        <ul className="space-y-2 mb-8">
          ...
          <li>
            <a
              href="#"
              className="display flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
            >
             <BiTransfer className="display flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
              <span className="flex-1 ml-3 whitespace-nowrap">Transaction(drop list)</span>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            <a
              ...
              className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <RiEyeFill className="display flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
          ...
          <li>
            <a
              ...
              className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
            >
             <RiMessage2Fill className="display
